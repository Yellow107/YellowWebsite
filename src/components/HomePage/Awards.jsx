...
const Awards = () => {
  ...
  return (
    <Section className="py-[5%] mobile:pb-[15%] " id="services">
      <div ref={containerRef} className="container h-[55vw] tablet:h-fit mobile:h-fit">
        <div className="space-y-[2.5vw] mobile:mt-[5vw] tablet:mt-[5vw] mobile:space-y-[7vw]">
          <SectionTitle data-title-anim text="AWARDS" />
        </div>

        <div className="absolute w-[90%] tablet:static tablet:w-full mobile:static mobile:w-full">
          <div
            className={`flex flex-wrap items-start justify-between pt-[5vw] gap-y-[1.2vw] mobile:flex-col mobile:gap-[5vw] mobile:pt-[10%] tablet:flex-col tablet:pt-[10%] tablet:gap-[3vw]  mobile:h-full tablet:h-full fadeup `}
          >
              ...
              >
                <div className="flex items-start w-full h-full justify-between">
                  <div className="flex flex-col justify-between items-start w-[70%] h-full">
                    ...
                    {/* always visible now */}
                    <div
                      className={`h-[5vw] w-[10vw] mobile:h-[10vw] mobile:w-[20vw] tablet:h-[8vw] tablet:w-[12vw] mobile:!opacity-100 tablet:!opacity-100 transition-all  ease-in-out ${enter == 0 && index == 0 ? "opacity-100 duration-500" : "opacity-0 duration-400"} ${enter == 1 && index == 1 ? "opacity-100 duration-500" : "opacity-0 duration-400"} ${index == 2 ? "hidden" : ""} `}
                    >
                      <Image
                        src={card.logo}
                        height={156}
                  ...
                  <div
                    className={`flex flex-col items-end justify-between h-fit absolute right-[2vw] gap-[4vw] mobile:right-[5vw] mobile:gap-[5vw]`}
                  >
